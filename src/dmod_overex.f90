...
module mod_overex 
      ...
      subroutine overex (rhoa,cva,rhob,cvb,ilev,jlev,klev,s,ia,ib)
         use mod_arrang , only: arrang
         use mod_qrot , only: qrot
         use mod_qvib , only: qvib
         use mod_prot , only: prot
         use mod_coords , only: coords 
      use mod_rotmel , only: rotmel
      use mod_pvibv , only: pvibv 
      use mod_rotmel , only: rotmel 
